---
title: "Lab 3: Rodent's GGPlot Activity"
date: today
...
> The variable types are characters, doubles, and dates while the variables are species id, sex, day of week, plot type, genus, species, taxa, record id, month, day, year, plot id, hindfoot length, weight, and date.
